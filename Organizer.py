...
# For storing all the File formats that are going to sort in the Organizer Folder create Directories
DIRECTORIES = {
...
# Get the file formats directory for all the items in current directory
FILE_FORMATS = {file_format: directory
                for directory, file_formats in DIRECTORIES.items()
                for file_format in file_formats}
# Funtion to organize the file
def organize_files():
